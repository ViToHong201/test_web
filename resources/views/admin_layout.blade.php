...
<link rel="stylesheet" href="{{asset('public/BE/css/morris.css')}}" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="{{asset('public/BE/css/monthly.css')}}">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="{{asset('public/BE/js/jquery2.0.3.min.js')}}"></script>
<script src="{{asset('public/BE/js/raphael-min.js')}}"></script>
<script src="{{asset('public/BE/js/morris.js')}}"></script>
</head>
<body>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle " href="#">
                <img alt="" src="{{asset('public/BE//images/user.png')}}">
                <span class="username">
                    <?php

                    $ten = Session::get('ten_quan_ly');
                    echo $ten;
                    ?>
                </span>
                <b class="caret"></b>
            ...
            <ul class="dropdown-menu extended logout">
                <li><a href="{{URL::to('/logoutadmin')}}"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="public/BE/js/flot-chart/excanvas.min.js"></script><![endif]-->
...
<!-- calendar -->
	<script type="text/javascript" src="{{asset('public/BE//js/monthly.js')}}"></script>
